...
#define LORAWAN_DEVICE_EUI                                 { IEEE_OUI, 0x01, 0x00, 0x00, 0x04, 0xC7 }
#define LORAWAN_NWK_KEY                                    { 0x20, 0xCD, 0x8C, 0xEF, 0x22, 0xE5, 0x84, 0x74, 0x55, 0xB3, 0x60, 0x9F, 0x8A, 0xD4, 0x40, 0xDA }
#define LORAWAN_JOIN_EUI                                   { 0x00, 0x25, 0x0C, 0x00, 0x00, 0x01, 0x00, 0x01 }

// 00250C01000004AC
#elif defined(DEVEUI_4AC) 

#define LORAWAN_DEVICE_EUI                                 { IEEE_OUI, 0x01, 0x00, 0x00, 0x04, 0xAC }
#define LORAWAN_NWK_KEY                                    { 0x00, 0x25, 0x0C, 0x01, 0x00, 0x00, 0x04, 0xAC, 0x00, 0x25, 0x0C, 0x01, 0x00, 0x00, 0x04, 0xAC } 
#define LORAWAN_JOIN_EUI                                   { 0x00, 0x25, 0x0C, 0x00, 0x00, 0x01, 0x00, 0x05 }

// 00250C010000048F
#elif defined(DEVEUI_48F) 
#define LORAWAN_DEVICE_EUI                                 { IEEE_OUI, 0x01, 0x00, 0x00, 0x04, 0x8F }
#define LORAWAN_NWK_KEY                                    { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }
#define LORAWAN_JOIN_EUI                                   { 0x00, 0x25, 0x0C, 0x00, 0x00, 0x01, 0x00, 0x05 }

#else
#error Device EUI not set
#endif
